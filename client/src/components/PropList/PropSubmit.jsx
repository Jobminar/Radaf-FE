    ...
    try {
      ...
      const requestBody = {
        ...
        propertyDimensions: {
          reception: {
            length:
              formDataWithDefaults.propertyDimensions?.reception?.length || 0,
            width:
              formDataWithDefaults.propertyDimensions?.reception?.width || 0,
          },
          kitchen: {
            length:
              formDataWithDefaults.propertyDimensions?.kitchen?.length || 0,
            width: formDataWithDefaults.propertyDimensions?.kitchen?.width || 0,
          },
          masterBedroom: {
            length:
              formDataWithDefaults.propertyDimensions?.masterBedroom?.length ||
              0,
            width:
              formDataWithDefaults.propertyDimensions?.masterBedroom?.width ||
              0,
          },
          bedroom: {
            length:
              formDataWithDefaults.propertyDimensions?.bedroom?.length || 0,
            width: formDataWithDefaults.propertyDimensions?.bedroom?.width || 0,
          },
        },
        nearby: {
          hospital: {
